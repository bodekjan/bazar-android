 ...
 */
public class MallKActivity extends AppCompatActivity {
    ImageView bigImage;
    TextView mallText;
    TextView mallPrice;
    TextView mallTotal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countLabel.setText(getResources().getText(R.string.countktext));
        ...
        String totalText=String.format(total,df.format(mallTotalNum));
        mallTotal.setText(totalText);
        Picasso.with(MallKActivity.this).load(Uri.parse("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1505360878&di=66899b62c71bd461f42c3d8933ed6eb4&imgtype=jpg&er=1&src=http%3A%2F%2Fpic.qiantucdn.com%2F58pic%2F19%2F47%2F10%2F56d96b77cbde3_1024.jpg")).into(bigImage);
        mallId = this.getIntent().getIntExtra("gooditem",-1);
        addCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(UserLib.get(MallKActivity.this).checkUser() && CommonHelper.token!=""){
                    Mall mall = new Mall();
                    User user = new User();
                    user.userPhone = UserLib.get(MallKActivity.this).getUser().userPhone;
                    mall.mallId = mallId;
                    mall.mallURL = mallUrl;
                    mall.mallPrice = (float)mallPriceNum;
                    mall.mallName = mallText.getText().toString();
                    mall.priceType = priceType;
                    CartLib.get(MallKActivity.this).addCart(user,mall,Double.valueOf(mallCount.getText().toString()));
                    InfoDialog.Builder builder = new InfoDialog.Builder(MallKActivity.this);
    ...
    class InitData extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            s.setSpan(new TypefaceSpan(MallKActivity.this, "ALKATIP.TTF"), 0, s.length(),
                    Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            spotsDialog = new SpotsDialog(MallKActivity.this,s);
            spotsDialog.show();
        }
        @Override
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("success"))
            {
                ...
                spotsDialog.dismiss();
                Toast.makeText(MallKActivity.this,"NET ERR",Toast.LENGTH_LONG);
            }
        }
        @Override
    ...
    public void initLayout(JSONObject jObject){
        try {
            ...
            Picasso.with(MallKActivity.this).load(CommonHelper.media+Uri.parse(jObject.getString("goodimg"))).into(bigImage);
